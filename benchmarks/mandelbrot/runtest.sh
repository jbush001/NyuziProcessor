...
# use verilator
$BASEDIR/rtl/obj_dir/Vverilator_tb +statetrace=statetrace.txt +bin=WORK/mandelbrot.hex +simcycles=250000 +memdumpbase=400 +memdumplen=4000 +memdumpfile=WORK/fb.bin +regtrace=1
$BASEDIR/tools/mkbmp/mkbmp WORK/fb.bin vsim.bmp 64 64
