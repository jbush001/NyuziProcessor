...
// Separate definitions for instruction cache
`define L1I_NUM_WAYS 4
`define L1I_SET_INDEX_WIDTH `CLOG2(`L1I_NUM_SETS)
//`define L1I_WAY_INDEX_WIDTH `CLOG2(`L1_NUM_WAYS)
`define L1I_WAY_INDEX_WIDTH 2
`define L1I_TAG_WIDTH (32 - `L1I_SET_INDEX_WIDTH - `CACHE_LINE_OFFSET_BITS)
