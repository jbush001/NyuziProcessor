...
_start:		move v0, 0
		...
		shr v1, v2, 278
		shl v3, v1, 325
		or_mask v2, s10, v3, 328
		and_mask v1, s10, v2, 218
		xor_mask v3, s10, v1, 117
		add_i_mask v2, s10, v3, 356
		sub_i_mask v1, s10, v2, 65
		mull_i_mask v3, s10, v1, 6
		mulh_u_mask v2, s10, v3, 51
		mulh_i_mask v1, s10, v2, 351
		ashr_mask v3, s10, v1, 133
		shr_mask v2, s10, v3, 369
		shl_mask v1, s10, v2, 5
		or v3, s1, 358
		and v2, s3, 448
		xor v1, s2, 107
		add_i v3, s1, 405
		...
		and_mask v3, s10, s1, 220
		xor_mask v2, s10, s3, 396
		add_i_mask v1, s10, s2, 491
		sub_i_mask v3, s10, s1, 437
		mull_i_mask v2, s10, s3, 13
		mulh_u_mask v1, s10, s2, 406
		mulh_i_mask v3, s10, s1, 181
		ashr_mask v2, s10, s3, 498
		shr_mask v1, s10, s2, 68
		shl_mask v3, s10, s1, 240
		clz s2, s3
		ctz s3, s2
		move s2, s3
		clz v3, v2
