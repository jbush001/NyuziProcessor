 ...
 */
/* From liboauth https://github.com/x42/liboauth */
...
int main (int argc, char **argv) {
	...
	printHash(sha1_result(&s));
	printf("\n\n");
	// CHECK: 84983e441c3bd26ebaae4aa1f95129e5e54670f1
	...
	printHash(sha1_result(&s));
	printf("\n\n");
    // CHECK: dea356a2cddd90c7a7ecedc5ebb563934f460452
	...
	printf("\n\n");
    // CHECK: 4f4ca3d5d68ba7cc0a1208c9c61e9c5da0403c0a
	...
	printHash(sha1_resultHmac(&s));
	printf("\n\n");
    // CHECK: 0922d3405faa3d194f82a45830737d5cc6c75d24
	...
	printHash(sha1_resultHmac(&s));
	printf("\n\n");
    // CHECK: bcf41eab8bb2d802f3d05caf7cb092ecf8d1a3aa
